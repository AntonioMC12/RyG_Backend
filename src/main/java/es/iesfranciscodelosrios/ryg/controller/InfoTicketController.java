...
public class InfoTicketController {
	 ...
	 * y devolver una lista de tickets
	...
	/**
	 * Método que recoge una petición http para hacer una consulta a la base de datos
	 * y devolver el ticket que le corresponda un id determinado
	 * @param id
