...
public class PremioController {
	 ...
	 * @return premio encontrado en la bd, o vacío si hay algún error
	 */
	@ApiOperation(value = "Crea un nuevo premio", notes = "Crea un nuevo premio siempre que tenga un id vÃ¡lido")
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Operación exitosa", response = Premio.class),
	 ...
	 * @return premio encontrado en la bd, o vacío si hay algún error
	 */
	@ApiOperation(value = "Edita un premio", notes = "Edita un premio siempre que tenga un id vÃ¡lido")
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Operación exitosa", response = Premio.class),
